...
function head()
{
    ...
    <title>Installation du patch NK Conversion 1.7.10</title>
...
function index()
{
   ...
   <div style="width:750px; margin:20px auto 0 260px;">
     ...
     <p style="margin: -30px 0 20px 0;">Version 2.0</p>  
     <h3>Description :</h3>
...
//******Mises à jour des tables******
  ...
  $sql = mysql_query("ALTER TABLE  " . $nuked['prefix'] . "_forums_cat ADD COLUMN (imagemini varchar(200))");
	$sql = mysql_query("INSERT INTO " . $nuked['prefix'] . "_config (name, value) VALUES ('forum_cat_prim', 'off')");
	...
	$sql = mysql_query("INSERT INTO " . $nuked['prefix'] . "_config (name, value) VALUES ('forum_quick_edit', 'non')");
	$sql = mysql_query("INSERT INTO " . $nuked['prefix'] . "_config (name, value) VALUES ('forum_quick_modo', 'non')");
	$sql = mysql_query("INSERT INTO " . $nuked['prefix'] . "_config (name, value) VALUES ('forum_quick_user', 'non')");
...
(1, 'on', 'off', 'on', 'off', 'off', 'on', 'on', 'on', 'on', 'on', 'on', 'on', 0)");


	?><h2 style="text-align:center;padding-top:50px;">Installation du patch "NK Conversion V2.0" éffectuée avec succès.<br /><br />Redirection...</h2><?php
